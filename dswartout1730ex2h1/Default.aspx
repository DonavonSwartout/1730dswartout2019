<%@ Page Title="Home Page" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="dswartout1730ex2h1._Default" %>
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            <div class="form-group">
                ...
                <asp:TextBox ID="TextBox19" runat="server">111 1st St, Lake City, MN 55401</asp:TextBox>
                <asp:TextBox ID="TextBox19Result" runat="server" Enabled="False"></asp:TextBox>
            </div>          
            <div class="form-group">
                <asp:Label ID="Label20" runat="server" Text="StringBuilder.Append:"></asp:Label>
                <asp:Label ID="Label20Result" runat="server" Text=""></asp:Label>
            </div>
            <div class="form-group">
